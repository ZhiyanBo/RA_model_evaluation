...
with col1:
    ...
    # st.image("./data/original_images/DX397935.jpg", width=2048)
    # img_path = "file:///Users/zhiyb/Documents/DPhil/yr2/Clinician_evaluation_study/streamlit_survey_v1/data/original_images/DX397935.jpg"
    # img_path = "./data/original_images/DX397935.jpg"
    ...
    # image_click_pop("./data/original_images/DX397935.jpg")

    image_click_pop_static("app/static/seed392/original_images/DX397935.jpg", 2252)

    # img_link= "app/static/seed392/original_images/DX397935.jpg"
    # html_string = f'<a href="{img_link}" target="_blank"><img src="{img_link}" width="{2048}" caption="legend"></a>'
    # # # Display the image using `st.markdown`
    # st.markdown(html_string, unsafe_allow_html=True)
    # st.markdown("[![Click me](app/static/original_images/DX397935.jpg)](https://streamlit.io)")
...
#         'visual_explanation': ["/Users/zhiyb/Documents/DPhil/yr2/Clinician_evaluation_study/streamlit_survey_v1/data/WI/heatmap_DX397935.jpg", 
#                                '/Users/zhiyb/Documents/DPhil/yr2/Clinician_evaluation_study/streamlit_survey_v1/data/RP_AMIL/heatmap_DX397935.jpg',
#                                '/Users/zhiyb/Documents/DPhil/yr2/Clinician_evaluation_study/streamlit_survey_v1/data/JL_AMIL/heatmap_DX397935.jpg',]
#     }
# )
...
with c13:
    # st.image("./data/WI_bar/heatmap_DX397935.jpg", width=2048)
    image_click_pop_static("app/static/seed392/WI_bar/heatmap_DX397935.jpg", width = 2252)
...
# with c13:
#     st.image("./data/WI/heatmap_DX397935.jpg", width=2048)
# with c14:
...
with c23:
    # st.image("./data/RP_AMIL_bar/heatmap_DX397935.jpg", width=2048)
    image_click_pop_static("app/static/seed392/RP_AMIL_bar/heatmap_DX397935.jpg", width = 2252)
...
with c33:
    # st.image("./data/JL_AMIL_bar/heatmap_DX397935.jpg", width=2048)
    image_click_pop_static("app/static/seed392/JL_AMIL_bar/heatmap_DX397935.jpg", width = 2048)
st.markdown("""---""")
