...
df_samples = pd.read_csv('./static/seed392/GT_predictions_seed392_20250430_rounded.csv')
...
def images_questions_display(df, idx):
    ...
    for i in range(3):
        ...
        with col1:
            ...
            image_click_pop_static(f"app/static/seed392/original_images/{filename}", width=2048)
        ...
        with col2:
            ...
            image_click_pop_static(f"app/static/seed392/{dir_list[model_idx]}/heatmap_{filename}", width=2252)
